            ...
            <div class="wrapper" class="clearfloat">
                <div class="top-bar">
                    ...
                    <div class="col center" style="text-align: right;">
                        <div class="menu-icon"><span class="icon-menu-icon"></span></div>
                        <div class="main-menu">
                            <ul id="main_nav">
                    ...
                    <div class="col right">
                        ...
                        <div class="main-menu">
                            <ul id="main_nav">
                                <li >
                                    <a class="btn btn-secondary btn-4 btn-join" target="_blank" href="https://app.axis.africa/login">Log In</a>
                                </li>
                            </ul>
                        </div>

                        <!-- <a target="_blank" href="https://app.axis.africa/login">
